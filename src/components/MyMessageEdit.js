...
class MyMessageEdit extends Component {
    ...
    render() {
        let {id , username,password,gender, birthDay, telephone, position, email, decManager, joinDate, address} = this.props.teacherManager;
            ...
            <React.Fragment>
                <div className="body teacher-list">
                    ...
                    <ol className="breadcrumb">
                        <li className="active"><i className="fa fa-edit" ></i>修改信息</li>
                    </ol>
                    <form className="form-horizontal" id="myMessage">
                        ...
                        <div className="form-group">
                            <label className="col-sm-2 control-label">密码<i className = "fa fa-file-powerpoint-o"></i></label>
                            <div className="col-sm-10">
                                <input
                                    type="text" className="form-control input-sm" value={password || ''} onChange={e=>this.changeHandler('password',e.target.value)}/>
                            </div>
                        </div>
                        <div className="form-group">
                            ...
                            <div className="col-sm-10">
                                <label className="radio-inline">
                                    <input
                                        type="radio" checked={gender==0} onChange={e=>this.changeHandler('gender',0) } onChange={e=>this.changeHandler('gender',0) } /> 男
                                </label>
                                <label className="radio-inline">
                                    <input
                                        type="radio" checked={gender==1} onChange={e=>this.changeHandler('gender',1) } onChange={e=>this.changeHandler('gender',1) } /> 女
                                </label>
